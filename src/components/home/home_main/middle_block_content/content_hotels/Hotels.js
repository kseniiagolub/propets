...
const Hotels = () => {
    ...
    const baseCollectionRefTree = query(collection(db, "hotels"));
    ...
    return (
        <div className={`${style.mainWhiteBack} d-flex flex-column col-6 align-items-center overflow-auto mt-3`}>
            <h1 className={`${style.titleSemiBold}`}><span className={`${style.titleBold}`}>Hotels. </span>Go to
                vacations — we’ll take care of your pet!</h1>
