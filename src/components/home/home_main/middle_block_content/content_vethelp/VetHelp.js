...
const VetHelp = () => {
    ...
    const baseCollectionRefTree = query(collection(db, "vethelp"));
    ...
    return (
        <div className={`${style.mainWhiteBack} d-flex flex-column col-6 align-items-center overflow-auto mt-3`}>
            <h1 className={`${style.titleSemiBold}`}><span className={`${style.titleBold}`}>VetHelp. </span>They deserve it.</h1>
